...
function ch11hw_set_default_options_array() {
	load_plugin_textdomain( 'ch11hw_hello_world', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
...
function ch11hw_hello_world_shortcode() {
	...
	$output = sprintf( __( 'The current text string is: %s.', 'ch11hw_hello_world' ), $options['default_text'] );
	return $output;
}
