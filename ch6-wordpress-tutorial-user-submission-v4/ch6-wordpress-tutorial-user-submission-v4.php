...
/*
  Plugin Name: Chapter 6 - Book Review User Submission v4
  Plugin URI:
...
function ch6_brus_book_review_form() {
	...
	<form method="post" id="add_book_review" action="">
		...
		<table>
			...
			<tr>
				<td colspan="2"><div class="g-recaptcha" data-sitekey="6LfeWSAUAAAAABlJnOb1w8yJeIC6B1xaUulr6hQT"></div></td>
			</tr> 
		</table>
...
function ch6_brus_process_user_book_reviews() {
	...
	$recaptcha = new \ReCaptcha\ReCaptcha( '6LfeWSAUAAAAAM28Q-Lz2ZcrSX8qSVks3dcPX-av' );
