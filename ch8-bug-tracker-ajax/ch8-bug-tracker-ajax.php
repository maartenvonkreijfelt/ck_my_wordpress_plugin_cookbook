<?php
/*
  Plugin Name:  8 - Bug Tracker v8
  Plugin URI:
  Description: Companion to recipe 'Importing data from a user file into custom tables'
...
function ch8bt_shortcode_list() {
	...
	$output .= 'value="' . $search_string . '" name="searchbt" />';
...
function ch8bt_load_jquery() {
	...
	wp_enqueue_style( 'bug_tracker_css', plugins_url( 'stylesheet.css', __FILE__ ), array(), '1.0' );
}